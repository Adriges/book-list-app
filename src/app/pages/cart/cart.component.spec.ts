...
describe('Cart component', () => {
    ...
    it('onImputNumberChange increments correctly', () => {
        const action = 'plus';
        const book = {
            name: '',
            author: '',
    ...
    it('onImputNumberChange decrements correctly', () => {
        const action = 'minus';
        const book = {
            name: '',
            author: '',
    ...
    /* este it prueba también el método privado */
    ...
    /* Este it solo provaría el método privado, cosa que no se debería hacer */
